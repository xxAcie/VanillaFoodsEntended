...
@Mod(AciesAdditionalFoods.MOD_ID)
public class AciesAdditionalFoods {
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "aciesadditionalfoods";
    // Directly reference a slf4j logger
    private static final Logger LOGGER = LogUtils.getLogger();

    public AciesAdditionalFoods(FMLJavaModLoadingContext context) {
