...
@Mod(VanillaFoodsExpanded.MOD_ID)
public class VanillaFoodsExpanded {
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "vanillafoodsexpanded";
    // Directly reference a slf4j logger
    private static final Logger LOGGER = LogUtils.getLogger();

    public VanillaFoodsExpanded(FMLJavaModLoadingContext context) {
    ...
    private void addCreative(BuildCreativeModeTabContentsEvent event) {
        if(event.getTabKey() == CreativeModeTabs.FOOD_AND_DRINKS){
            ...
            event.accept(ModItems.EGGS_AND_BACON);
            event.accept(ModItems.OATMEAL_CREAM_PIE);
